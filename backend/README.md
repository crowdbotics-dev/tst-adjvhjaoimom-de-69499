...
## Project Structure
    ...
    ├── tst_adjvhjaoimom_de_69499  # Django project configurations
...
1. Clone this repo and `cd tst_adjvhjaoimom_de_69499`
...
2. Clone this repo and `cd tst_adjvhjaoimom_de_69499`
